 ...
 */
public class MainPanel extends VisDialog {
    ...
    public void setSaveListener(ClickListener saveListener) {
        ...
        if (saveBtn != null) saveBtn.addListener(saveListener);
    }

    private void initView(int[] nines) {
        editingTable.clear();
        editingZone = new EditingZone();
        editingZone.setTexture(texture, nines);
        ...
        editingZone.setListener(new EditingZone.PatchChangeListener() {
            ...
            public void changed(int[] splits) {
                previewWidget.update(texture,splits );
            }
        });
    }
    ...
    public void setTexture(TextureRegion texture, int[] nines) {
